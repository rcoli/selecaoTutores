...
$.extend($.fn, {
	...
	validate: function( options ) {
		...
		if (!this.length) {
			options && options.debug && window.console && console.warn( "Valor não selecionado, impossível validar, retorno nulo" );
			return;
		}
...
$.extend($.validator, {
	...
	messages: {
		...
		dateISO: 						"Por favor digite uma data válida (aaaa-mm-dd).",
		dateDE: 						"Por favor digite uma data válida (dd/mm/aaaa).",
