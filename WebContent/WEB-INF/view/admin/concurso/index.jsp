...
<div id="mainContent">
	<h1>Concursos &raquo; Listagem</h1>
	...
	<table
		...
		<thead>
			<tr>
				<th><strong><a href="">Ano</a></strong></th>
		...
		<c:forEach items="${concursos}" var="concurso" varStatus="sts">
			<tr>
				...
				<td><a
					href="${pageContext.request.contextPath}/admin/concurso/atualizacao/${concurso.id}"
				...
				<td><c:choose>
						<c:when test="${concurso.id ge 0}">
							<a
								href="${pageContext.request.contextPath}/admin/concurso/exclusao/${concurso.id}"
