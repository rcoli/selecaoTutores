	...
	<table
		...
		<thead>
			<tr>
				...
				<th><strong><a href="">Início</a></strong></th>
				<th><strong><a href="">Fim</a></strong></th>
		...
		<c:forEach items="${fases}" var="fase" varStatus="sts">
			<tr>
				<td>${fase.concurso.nome}</td>
				<td>${fase.inicio}</td>
				<td>${fase.fim}</td>
				<td>${fase.nome}</td>
				<td>${fase.sigla}</td>
				<td><a
					href="${pageContext.request.contextPath}/admin/fase/atualizacao/${fase.id}"
				...
				<td><c:choose>
						<c:when test="${fase.id ge 0}">
							<a
								href="${pageContext.request.contextPath}/admin/fase/exclusao/${fase.id}"
